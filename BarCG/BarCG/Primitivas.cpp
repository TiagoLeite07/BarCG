...
void rectangulo(float comprimento,float largura,float altura){
	float alfa;
	float delta = (2*M_PI)/4;
	float raio = sqrt(pow(altura,2)/2);

	glBegin(GL_TRIANGLES);
	//desenha rectangulo superior
	...
	//desenha rectangulo lados
		//desenha rectangulo lado frente
			glColor3f(1,1,0);
		glVertex3f(-largura/2,altura/2,comprimento/2);
		glVertex3f(-largura/2,-altura/2,comprimento/2);
		glVertex3f(largura/2,-altura/2,comprimento/2);
		...
		glVertex3f(-largura/2,-altura/2,-comprimento/2);
		glVertex3f(-largura/2,altura/2,-comprimento/2);
		//desenha rectangulo lado direito
			glColor3f(1,1,0);
		glVertex3f(largura/2,altura/2,comprimento/2);
		glVertex3f(largura/2,-altura/2,comprimento/2);
		glVertex3f(largura/2,-altura/2,-comprimento/2);
		...
		//desenha rectangulo lado esquerdo
			glColor3f(1,1,0);
		glVertex3f(-largura/2,altura/2,-comprimento/2);
		glVertex3f(-largura/2,-altura/2,-comprimento/2);
		glVertex3f(-largura/2,-altura/2,comprimento/2);
